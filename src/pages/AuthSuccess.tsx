          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <img
                ...
                className="w-8 h-8"
              />
              <h1 className="text-2xl font-bold text-red-800">LeibnizDream</h1>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-16 max-w-2xl">
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-red-600">Your access token is ready.</p>
          </div>

          {/* Token Card */}
          <Card className="text-left border-red-200">
            <CardHeader className="bg-red-50">
              <CardTitle className="text-red-800">Access Token</CardTitle>
            </CardHeader>
          ...
          <Card className="text-left border-red-200">
            <CardHeader className="bg-red-50">
              <CardTitle className="text-red-800">Next Steps</CardTitle>
            </CardHeader>
            <CardContent className="pt-6">
